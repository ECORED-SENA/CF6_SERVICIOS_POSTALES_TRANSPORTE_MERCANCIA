...
.curso-main-container.pb-3.animated.fadeIn
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-4
      p.col-6 <b>Una estrategia es aquella cadena planeada y medida de eventos que permite lograr objetivos predefinidos en el tiempo esperado y con la sustancia de resultados requerida por el objetivo que se persigue.</b>
      p.col-6 Los servicios postales, al igual que todos los procesos de servicio, buscan garantizar su continuidad mediante estrategias dirigidas principalmente a los clientes (no solamente a ellos) que permitan los espacios de desarrollo del negocio, su medida, mejora continua y competitividad en el mercado.  
        
    p.mb-5 En la actualidad las empresas pueden disponer de una serie de herramientas tecnológicas que facilitan el proceso estratégico de servicio al cliente generando crecimiento no solo desde lo económico y la participación en el mercado sino también desde el reconocimiento e identificaron de la empresa en el medio, estas herramientas tecnológicas facilitan procesos como:
    ...
    p.mb-5 Ya definido con claridad los conceptos de petición, queja, reclamo y sugerencia, las estrategias de los servicios postales, en su diseño, claramente deberán enfocarse como mínimo en los siguientes objetivos  
    
    figure.mb-5
      .col-9.pos5
        img(src="@/assets/curso/tema4/vec2.svg")
    
    p.mb-4 Para lograr desarrollar cada uno de los objetivos anteriores, las organizaciones de servicios postales están obligadas a implementar el mecanismo de PQRS, no solamente para lograr mejora continua de la atención al cliente, sino en no menor importancia, recaudar los datos y evidencias de forma permanente que permitan ser tabuladas y analizadas, convirtiéndolas en indicadores e información de garantía de mejora continua del servicio.
    p.mb-4 En las empresas de servicios postales y transporte de mercancías se tiene definido el procedimiento para el trámite de recepción de PQR, este documento contiene información como: 

    .row.col-11.pos6.mb-5
